    ...
    <div class="col-12">
      ...
      <div class="card shadow mb-4 rounded-0">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-muted">Today Attendance</h6>
          <a class="text-reset font-weight-bolder text-muted" title="Go to Department List" href="<?= base_url('admin') ?>"><i class="fa fa-arrow-right"></i></a>
        </div>
        <!-- Card Body -->
        <div class="card-body overflow-auto" style="max-height: 400px;">
          <table class="table table-bordered table-striped w-100">
            <thead class="bg-gradient-primary text-white">
              <tr>
                ...
                <th class="p-1" scope="col">Gender</th>
            ...
            <tbody>
              ...
              foreach ($a_list as $a) : ?>
                <tr>
                  ...
                  echo '<td class="p-1">' . date('h:i:s A', $a['in_time']) . '</td>';
                  echo '<td class="p-1">' . ($a['out_time'] > 0 ? date('h:i:s A', $a['out_time']) : 'Haven\'t Checked Out') . '</td>';
                   ?>
