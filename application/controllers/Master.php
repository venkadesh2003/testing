...
class Master extends CI_Controller
{
  ...
  private function _addEmployee()
  {
    ...
    $security = $this->input->post('e_security');
  ...
  public function e_employee($e_id)
  {
    ...
    $this->form_validation->set_rules('e_security', 'security answer', 'required|trim');
    ...
    if ($this->form_validation->run() == true) {
      ...
      $e_security = $this->input->post('e_security');
